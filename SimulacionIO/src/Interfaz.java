...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mensajeCancel = new javax.swing.JLabel();
        ...
        botonDetener.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/stop.png"))); // NOI18N
        ...
        mensajeExito.setForeground(new java.awt.Color(0, 204, 0));
        mensajeExito.setText("Simulación finalizada.");
        mensajeExito.setVisible(false);

        mensajeCancel.setForeground(new java.awt.Color(255, 0, 0));
        mensajeCancel.setText("Simulación interrumpida.");
        mensajeCancel.setVisible(false);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(mensajeExito, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(mensajeCancel, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addContainerGap())
        );
    ...
    private void botonRegresarDeInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRegresarDeInfoActionPerformed
        panelContenedor.removeAll();
        panelContenedor.repaint();
        panelContenedor.revalidate();
        ...
        panelContenedor.repaint();
        panelContenedor.revalidate();
    }//GEN-LAST:event_botonRegresarDeInfoActionPerformed

    private void botonRegresarDeAyudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRegresarDeAyudaActionPerformed
        panelContenedor.removeAll();
        panelContenedor.repaint();
        panelContenedor.revalidate();
        ...
        panelContenedor.repaint();
        panelContenedor.revalidate();
    }//GEN-LAST:event_botonRegresarDeAyudaActionPerformed
    ...
    private boolean revisarEntradas(){
        ...
        // Entrada número de simulaciones
        try{
        ...
        try{
            if ( Double.parseDouble(entradaTT.getText()) > 0 ){
        ...
        // Entrada duración del token
        try{
            if ( Double.parseDouble(entradaDT.getText()) > 0 ){
    ...
    public void fin(){
        ...
        // Si la simulación terminó con éxito
    ...
    public double getTiempoTotal(){
        ...
        double tiempoTotal = Double.parseDouble(entradaTT.getText());
        return tiempoTotal;
    }
    ...
    public double getDuracionToken(){
        ...
        double duracionToken = Double.parseDouble(entradaDT.getText());
    ...
    private javax.swing.JLabel mensajeCancel;
